...
public:
    explicit SoftminTypeBasedOpenList(const plugins::Options &opts);
...
template<class Entry>
SoftminTypeBasedOpenList<Entry>::SoftminTypeBasedOpenList(const plugins::Options &opts)
...
class SoftminTypeBasedOpenListFeature : public plugins::TypedFeature<OpenListFactory, SoftminTypeBasedOpenListFactory> {
public:
    SoftminTypeBasedOpenListFeature() : TypedFeature("softmin_type_based") {
        document_title("SoftminType-based open list");
        document_synopsis(
...
static plugins::FeaturePlugin<SoftminTypeBasedOpenListFeature> _plugin;
}
