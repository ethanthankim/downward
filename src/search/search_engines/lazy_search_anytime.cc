...
LazySearchAnytime::LazySearchAnytime(const plugins::Options &opts)
    : SearchEngine(opts),
...
void LazySearchAnytime::initialize() {
...
void LazySearchAnytime::print_statistics() const {
    statistics.print_detailed_statistics();
    search_space.print_statistics();
}


SearchStatus LazySearchAnytime::step() {
...
void LazySearchAnytime::dump_search_space() const {
