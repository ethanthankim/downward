...
def main():
    ...
    CONFIGS = [
        ...
        IssueConfig('LWM-bias/bias', ["--evaluator", f"h={unit_ff}", '--search', f'eager(lwm_partition(h, inter_biased_depth(tau=2, ignore_size=true, random_seed={FF_RANDOM_SEED}), intra_biased(h, ignore_size=true, random_seed={FF_RANDOM_SEED})), {unit_cost}) '] , driver_options=DRIVER_OPTIONS)
