...
def main():
    ...
    CONFIGS = [
        ...
        IssueConfig('HIB-alt|bias/bias', ["--evaluator", f"h={unit_ff}", '--search', f'eager(alt( [ single(h), bias_depth_bias_h(h, inter_tau=1, intra_ignore_size=true, random_seed={FF_RANDOM_SEED}) ] ), {unit_cost}) '] , driver_options=DRIVER_OPTIONS),
