...
def main():
    ...
    CONFIGS = [
        ...
        IssueConfig('LWM-bias/bias', ["--evaluator", f"h={unit_ff}", '--search', f'eager(lwmb_partition(h, inter_biased_depth(ignore_size=true, random_seed={FF_RANDOM_SEED}), intra_biased(ignore_size=true, random_seed={FF_RANDOM_SEED})), {unit_cost}) '] , driver_options=DRIVER_OPTIONS)
