...
def main():
    ...
    CONFIGS = [
        ...
        IssueConfig('LWM-bias/bias', ["--evaluator", f"h={unit_ff}", '--search', f'eager(lwm_partition(hff, inter_biased_depth(tau=2.0, ignore_size=true), intra_biased(hff, ignore_size=true, random_seed={FF_RANDOM_SEED})), {unit_cost}) '] , driver_options=DRIVER_OPTIONS),
